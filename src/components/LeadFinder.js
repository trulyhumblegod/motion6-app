        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="max-w-3xl mx-auto">
                <form onSubmit={handleSearch} className="relative group">
                    ...
                    <input
                        ...
                        placeholder="Buscar por dominio o industria (ej. stripe.com o AI SaaS)"
                    ...
                    <div key={lead.id} className="bg-white border border-slate-100 rounded-[32px] p-6 shadow-sm hover:shadow-2xl hover:shadow-primary/10 transition-all group relative overflow-hidden">
                        ...
                        <div className="space-y-4">
                            <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
                                <p className="text-xs font-bold text-slate-500 mb-1">Empresa</p>
                                <p className="text-sm font-black text-slate-900">{lead.company}</p>
                            </div>
                            <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
                                <p className="text-xs font-bold text-slate-500 mb-1">Correo</p>
            ...
            {hasSearched && results.length === 0 && !isSearching && (
                <div className="py-20 text-center">
                    ...
                    <p className="text-slate-400 font-bold italic text-xl">No se encontraron leads para "{query}". Intenta un término más amplio.</p>
                </div>
            )}
        </div>
    );
